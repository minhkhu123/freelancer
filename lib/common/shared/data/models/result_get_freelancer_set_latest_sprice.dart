...
class ResultGetFreelancerSetLatestPrice {
  ResultGetFreelancerSetLatestPrice({
    this.data,
    this.error,
  });
  ...
  factory ResultGetFreelancerSetLatestPrice.fromRawJson(String str) => ResultGetFreelancerSetLatestPrice.fromJson(json.decode(str));
  String toRawJson() => json.encode(toJson());

  factory ResultGetFreelancerSetLatestPrice.fromJson(Map<String, dynamic> json) => ResultGetFreelancerSetLatestPrice(
...
class Data {
  ...
  final bool result;
  final List<DsDatgia> dsDatgia;

  factory Data.fromJson(Map<String, dynamic> json) => Data(
    result: json["result"] == null ? null : json["result"],
    dsDatgia: json["ds_datgia"]  == ''? '' : List<DsDatgia>.from(json["ds_datgia"].map((x) => DsDatgia.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "result": result == null ? null : result,
    "ds_datgia": dsDatgia == null ? null : List<dynamic>.from(dsDatgia.map((x) => x.toJson())),
  };
}
class Error {
  int code;
