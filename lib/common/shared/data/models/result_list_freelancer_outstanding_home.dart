...
//
//     final resultListFreelancerOutstandingHome = resultListFreelancerOutstandingHomeFromJson(jsonString);

import 'dart:convert';

ResultListFreelancerOutstandingHome resultListFreelancerOutstandingHomeFromJson(String str) => ResultListFreelancerOutstandingHome.fromJson(json.decode(str));

String resultListFreelancerOutstandingHomeToJson(ResultListFreelancerOutstandingHome data) => json.encode(data.toJson());

class ResultListFreelancerOutstandingHome {
  ResultListFreelancerOutstandingHome({
    this.data,
    this.error,
  });
  ...
  factory ResultListFreelancerOutstandingHome.fromJson(Map<String, dynamic> json) => ResultListFreelancerOutstandingHome(
...
class Data {
  ...
  bool result;
  List<ListFlcOutstandingHome> listFlc;

  factory Data.fromJson(Map<String, dynamic> json) => Data(
    result: json["result"] == null ? null : json["result"],
    listFlc: json["list_flc"] == null ? null : List<ListFlcOutstandingHome>.from(json["list_flc"].map((x) => ListFlcOutstandingHome.fromJson(x))),
  );
...
class ListFlcOutstandingHome {
  ListFlcOutstandingHome({
    this.avatar,
    this.path,
    this.hoTen,
    this.maUser,
  ...
  factory ListFlcOutstandingHome.fromJson(Map<String, dynamic> json) => ListFlcOutstandingHome(
