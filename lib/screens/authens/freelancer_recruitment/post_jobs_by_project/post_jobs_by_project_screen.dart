...
class PostJobsByProjectScreen extends StatelessWidget {
  final DataPost dataPost;

  PostJobsByProjectScreen({this.dataPost});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: GetBuilder<PostJobsByProjectController>(
        init: PostJobsByProjectController(dataPost: dataPost),
        builder: (controller) => Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Rectangle(height: height * 0.04, title: "Việc cần tuyển Freelancer"),
            Obx(() => Container(
                  height: height * 0.5,
                  width: width,
            ...
            CustomTextFieldFreelanceRecruitment(
              text: "Đặt tên cụ thể cho công việc cần tuyển",
            ),
            ...
            Rectangle(height: height * 0.08, title: "Thông tin đầy đủ về yêu cầu tuyển dụng"),
            SizedBox(height: 30),
            ...
            SizedBox(height: 30),
            CustomTextFieldFreelanceRecruitment(text: "Kỹ năng Freelancer"),
            SizedBox(height: 10),
            SelectDropList(
